...
public class ThreadServerMio implements Runnable {
	
	private Socket socket = null;
	private static final String newLine = "\r\n";
	
	public ThreadServerMio(Socket socketCliente)
	{
	...
	public static void main(String[] args) throws IOException
	{
		...
		final int port = 8080;
			...
			ThreadServerMio threadServer = new ThreadServerMio(serverSocket.accept());
	          Thread hilo = new Thread (threadServer);
	          hilo.start();
